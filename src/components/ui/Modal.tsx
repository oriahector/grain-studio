      ...
      >
        <div className="p-6 h-full flex flex-col">
          <div className="mb-4 flex items-center">
            ...
            {title && <div className=" uppercase tracking-wide text-lg md:text-2xl flex items-center text-klein font-anton">Grain             <img src="images/grain.svg" alt="icon" className="w-2 h-2 object-contain text-klein" /> Studio</div>}
          </div>
          {children}
        </div>
      </aside>
